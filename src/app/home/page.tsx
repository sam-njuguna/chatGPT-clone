"use client";
import { Navbar, Suggestion, Svg, Textarea } from "@/components";
      ...
      <div className="w-full supports-[height:100dvh]:h-[100dvh] relative  ">
        <div className="max-w-3xl w-full mx-auto max-xtablet:px-2 flex flex-col justify-center">
          <div className="h-[98px] flex justify-center items-center w-full">
            <div className="flex items-center h-[54px] max-xphone:w-full p-1 sm:h-[50px]  gap-1 sm:p-1 bg-home-color-light_btn dark:bg-home-color-nav_bg rounded-lg">
              <button
                className={twMerge(
                  "h-full flex gap-2 items-center justify-center  w-[148px] max-xphone:w-full bg-white dark:bg-[#444654a4] border border-[#a7a7a7] rounded-lg font-semibold text-home-color-dark_btn dark:text-home-color-dark_text ",
              ...
              <button className="h-full group flex items-center justify-center gap-2 w-[148px] max-xphone:w-full btn font-semibold text-[#8e8ea0]">
        ...
        <div className="absolute w-full left-0 bottom-0 pb-6">
          <div className="max-w-3xl mx-auto max-xphone:px-2 max-xtablet:px-4 max-lg:px-6 flex flex-col gap-4 justify-center ">
            <Suggestion />
            <div className="relative z-20 text-gray-600 flex flex-col gap-3 dark:text-gray-300">
              <Textarea />
